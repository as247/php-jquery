<?php
namespace PhpJquery\Dom;

use PhpJquery\Exceptions\CircularException;
use PhpJquery\Exceptions\ParentNotFoundException;
use PhpJquery\Selector;
 ...
 * @property \PhpJquery\Dom\Tag tag
 * @property AbstractNode parent
 */
abstract class AbstractNode
{
     ...
     * @param int $nth
     * @return HtmlNode|HtmlNode[]|AbstractNode[]|AbstractNode|Collection
     */
