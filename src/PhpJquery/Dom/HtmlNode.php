...
use PhpJquery\Dom\Concerns\HasChildren;
use PhpJquery\Exceptions\UnknownChildTypeException;
use PhpJquery\Exceptions\ChildNotFoundException;
use IteratorAggregate;
use Countable;
/**
 * Class HtmlNode
 *
 * @package PhpJquery\Dom
 */
class HtmlNode extends AbstractNode implements IteratorAggregate, Countable
{
